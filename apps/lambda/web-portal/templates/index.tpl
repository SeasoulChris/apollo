...
<head>
    ...
    <title>Apollo Fuel Portal</title>
            ...
            <div class="col-md-8 order-md-1">
                ...
                <form class="needs-validation" novalidate>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="invalid-feedback">Please enter a valid email address for acceptting the job report.</div>
                    </div>
                    ...
                    <div class=" mb-3">
                        ...
                        <select class="custom-select d-block w-100" id="job_type" required>
                            ...
                            <option value="VEHICLE_CALIBRATION">Vehicle Calibration</option>
                        </select>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="invalid-feedback">Bucket Name required.</div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="cc-name">Zone Id</label>
                            <input type="text" class="form-control" id="zone_id" placeholder="">
                            <div class="invalid-feedback">Zone Id is required.</div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="invalid-feedback">Access Secret is required.</div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="invalid-feedback">Input Data Path required.</div>
                    </div>
