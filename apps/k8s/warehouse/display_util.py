...
def plot_record(record):
    ...
    base_speed_jerk = {0: [0, 1, 2, 3, 4], 1: [2, 3, 1, 0, 4, 5], 2: [2, 1, 0, 3, 4, -1],
                       3: [1, 0, 2, 3, 4, 5, -1, -2], 4: [0, -1, 1, 3, 4, 2, -2, 5],
                       5: [0, 1, 2, 3, -1, 4], 6: [1, 2, 0, 3, -1, 4, 5],
                       7: [2, 1, 0, -1, 3, 4, -2, 5], 8: [0, -1, 1, 2, 3, 4], 9: [0, 1, 2, -1],
                       10: [0, 1, -1, 2], 11: [0, -2, -1, 1, 2], 12: [0, -1, 1, -2, 2, 3],
                       13: [-1, -2, 0, 1, 2], 14: [0, 1, -1, -2, -3, 2, 3], 15: [0, 1, 2, -1, -2],
                       16: [0, 1, -1, 2, -2], 17: [0, 1, 2], 18: [0, 1, 2, -1], 19: [0, 1]}
    ...
    base_speed_jerk = {0: [0, 1, 2, 3, -1, -2, -3, -5, -4, 4, 5],
                       1: [3, 4, 2, 1, -1, -2, -3, 0, -4, -5, -6],
                       2: [1, 0, -1, -2, -5, -6, -4, -3, 2, 3],
                       3: [0, -1, 1, -2, -3, -4, -5, 2, 3, 4, 5, -6, -7],
                       4: [0, -1, 1, 2, 3, -2, -3, 4, -4], 5: [0, -1, 1, 2, 3, 4, -2, -3],
                       6: [0, 1, -1, -2, 2, -3, -4, 3], 7: [0, 1, 2, 3, 4, -1, -2, -3],
                       8: [0, -1, 1, 2, 3, 4, -2], 9: [0, -1, 1], 10: [0, -1, 1, 2, -2],
                       11: [0, -1, -2, 1], 12: [0, -1, -2], 13: [-1, -2, 0],
                       -11: [0, 1, 3, 2], -18: [0, 1], -17: [0, 1, -1, 2], -16: [0, 1, -1, 2],
                       -15: [0, 1, 2, 3], -14: [0, -1, 1, 2, 3, 4], -13: [0, 1, 2, 3, -1],
                       -12: [0, 1, -1, 3, 2], -1: [-1, 0, 1, 3, 4, 2, -2, -3, -4, 5, 6],
                       -10: [0, 1, -1, 2, 3], -9: [0, 1, -1, 2], -8: [0, 1, 2, 5, 4, 3],
                       -7: [0, 1, 4, 3, 5, 2], -6: [0, 1, 2, 4, 5, 3, -1],
                       -5: [1, 0, 3, 2, -1, 4, 5], -4: [3, 2, 4, 1, 0, -1],
                       -3: [1, 0, 2, 3, -1, 4, 5, 6], -2: [0, 1, 2, 3, 4, 5, -1, -3, -2, 6]}
