...
def write_h5_train_test(elem):
    ...
    throttle_train_file = h5py.File(
        "{}/throttle_train_{}.hdf5".format(folder_path, key), "w")
    ...
    throttle_test_file = h5py.File(
        "{}/throttle_test_{}.hdf5".format(folder_path, key), "w")
    ...
    brake_train_file = h5py.File(
        "{}/brake_train_{}.hdf5".format(folder_path, key), "w")
    ...
    brake_test_file = h5py.File(
        "{}/brake_test_{}.hdf5".format(folder_path, key), "w")
