...
# Feature extraction.
JOB="fueling/control/calibration_table/multi-vehicle-calibration-table-feature-extraction.py"
ENV="fuel-py27-cyber"
...
JOB="fueling/control/calibration_table/multi-vehicle-result-visualization.py"
ENV="fuel-py27"
./tools/submit-job-to-k8s.sh --env ${ENV} --workers 12 --cpu 2 --memory 20g ${JOB}
