...
ENV="fuel-py27"
INPUT_DATA_PATH="modules/control/calibration_table/records"
OUTPUT_DATA_PATH="modules/control/calibration_table/results/CalibrationTableConf"
./tools/submit-job-to-k8s.sh --env ${ENV} --workers 5 --cpu 10 --memory 100g ${JOB} \
--input_data_path="${INPUT_DATA_PATH}" --output_data_path="${OUTPUT_DATA_PATH}" --job_id="001"
