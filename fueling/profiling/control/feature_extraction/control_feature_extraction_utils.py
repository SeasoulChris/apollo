...
def extract_data_at_multi_channels(msgs, driving_mode, gear_position, control_error_code):
...
def get_config_control_profiling():
    ...
    profiling_conf = '/fuel/fueling/profiling/conf/control_profiling_conf.pb.txt'
