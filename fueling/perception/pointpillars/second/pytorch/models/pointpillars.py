...
from fueling.perception.pointpillars.second.pytorch.models.voxel_encoder import (
...
class PFNLayer(nn.Module):
    def __init__(self,
        ...
        but the PointPillars paper results only
        used a single PFNLayer. This layer performs a similar role
        as second.pytorch.voxelnet.VFELayer.
