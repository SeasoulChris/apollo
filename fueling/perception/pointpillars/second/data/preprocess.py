...
def merge_second_batch(batch_list):
    ...
    for key, elems in example_merged.items():
        if key in [
                'voxels', 'num_points', 'num_gt', 'voxel_labels', 'gt_names',
                'gt_classes', 'gt_boxes'
        ]:
...
def prep_pointcloud(input_dict,
        ...
        if db_sampler is not None:
            ...
            if sampled_dict is not None:
                ...
                sampled_gt_importance = np.full(
                    [sampled_gt_boxes.shape[0]], sample_importance, dtype=sampled_gt_boxes.dtype)
    ...
    if create_targets:
        ...
        bev_map = simplevis.draw_box_in_bev(bev_map, [-50, -50, 3, 50, 50, 1],
        ignored_anchors, [128, 128, 128], 2)
        bev_map = simplevis.draw_box_in_bev(bev_map, [-50, -50, 3, 50, 50, 1],
        assigned_anchors, [255, 0, 0])
        ...
        pp_map = simplevis.draw_box_in_bev(pp_map, [-50, -50, 3, 50, 50, 1],
        boxes_lidar, [128, 0, 128], 1)
