...
def downloadVideo(keyword, video_storage_location, number_of_results=100):
    ...
    for v_id in result_id_set:
        ...
        if os.path.exists(file_path_name):
            print("***Found {}".format(file_path_name))
            ...
            while success:
                ...
                if (i % int(fps) == 0):
                    ...
                    if not cv2.imwrite(address, frame):
                        ...
                        print('save image:', j)
                        try:
                            print("!!!!HERE is the path: {}".format(address))
                            print("BOS:", 'cd {} && ./bos_fstool --src={} --dst={}/{}/{}/{}'.format(
                                bos_tool_path,
                                address,
                                bos_file_path,
                                video_storage_location,
...
# downloadVideo("police cars responding", 'data/PoliceVid', 1)
