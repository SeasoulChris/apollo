...
from fueling.planning.models.trajectory_imitation_model import TrajectoryImitationModel, TrajectoryImitationLoss
...
if __name__ == "__main__":
    ...
    # Set-up data-loader
    train_dataset = ImgInTrajOutDataset(args.train_file)
    valid_dataset = ImgInTrajOutDataset(args.valid_file)
