...
class SpeedLimitImgRenderer(object):
    ...
    def __init__(self, config_file, region_base_speedlimit_img_dict):
        ...
        self.region_base_speedlimit_img_dict = region_base_speedlimit_img_dict
    ...
    def draw_speedlimit(self, region, center_x, center_y, center_heading, coordinate_heading=0.):
        base_speedlimt_img = self.region_base_speedlimit_img_dict[region]
        map_size_h = base_speedlimt_img.shape[0]
        ...
        rough_local_map = base_speedlimt_img[center_basemap_idx[1] - self.rough_crop_radius:
